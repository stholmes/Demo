...
{"city":"Columbia", "lon":-76.839, "lat":39.24},
{"city":"Silver Spring", "lon":-77.026, "lat":38.991},{"city":"Bethesda", "lon":-77.17, "lat":38.91},{"city":"Washington D.C.", "lon":-77.0369, "lat": 38.9072}
...
function redraw_map(svg, values, index){
    ...
    add_capital(svg)
   // info(values[index].features, index)
...
function info(session, index){
    ...
    d3.select('#infopane')
        ...
        .append('text')
        .append('tspan')
        .text('Information about District 3:')
